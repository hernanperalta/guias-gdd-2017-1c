/*1)
Obtener el número de cliente, la compañía, y número de orden de todos los clientes que
...
/*
2) 
Listar los ítems de la orden número 1004, incluyendo una descripción de cada uno. El
...
/*
3) 
Listar los items de la orden número 1004, incluyendo una descripción de cada uno. El
listado debe contener: Número de orden (order_num), Número de Item (item_num),
...
/*
4)
Se desea listar todos los clientes que posean órdenes de compra. Los datos a listar son
...
/*
6) 
Se requiere listar para armar una nueva lista de precios los siguientes datos: nombre del
...
/*
7) 
Se requiere un listado de los items de la orden de pedido Nro. 1004 con los siguienes
...
/*
8) 
Informar el nombre del fabricante (manu_name) y el tiempo de envío (lead_time) de las
...
/*
9) 
Se requiere un listado de las todas las órdenes de pedido con los siguienes datos:
...
/*
10) 
Se requiere un listado con la siguiente información:
